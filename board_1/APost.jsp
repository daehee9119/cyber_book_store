...
<table valign="top" width="70%" cellspacing=0 cellpadding=3>
 <tr>
                        <td bgcolor=84F399 height="30" align=center>공지사항 등록</td>
 </tr>
</table>
<br>
<table width="70%" cellspacing=0 cellpadding=3 align=center>
<form name=post method=post action="../board_1/APostProc.jsp">
 <tr>
  <td align=center>
   <table border=0 width="100%" align=center>
                                <tr>
                                    ...
                                    <td width="78%">
                                        <p><input type=text name=subject size="65" maxlength=30></p>
</td>
    </tr>
    <tr>
     <td width="21%">내 용</td>
    ...
    <tr>
     <td width="21%">&nbsp;</td> 
     <td width="78%"><input type=hidden name=pass size=15 maxlength=15 value="admin"></td>
    </tr>
    <tr>
