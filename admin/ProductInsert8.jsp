	...
	<td align="center" bgcolor="#FFFFff">
		...
		<form name="regForm" method="post" action="ProductProc.jsp?flag=insert" enctype="multipart/form-data">
			...
			<td align="center" width="104" bgcolor="#99CCCC">도서수량</td>
                        <td width="523" bgcolor="#FFCC99"><input type="text" name="stock" size="10" value="10000"> 개</td>
			</tr>
			<tr> 
			<tr> 
			<td align="center" width="104" bgcolor="#99CCCC">도서가격</td>
                        <td width="523" bgcolor="#FFCC99"><input type="text" name="price" size="10" maxlength="6"> 원</td>
			</tr>
			<tr> 
			...
			<td colspan="2" align="center" width="633" bgcolor="yellow" height="49"> 
				<input type="button" value="도서등록" onclick="inputCheck();" >&nbsp;&nbsp;&nbsp;
