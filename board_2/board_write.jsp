								...
								<TD>
									<TABLE border="0" cellpadding="0" cellspacing="0" width="529">
										...
										<TR>
											...
											<TD width=400 font class=board>&nbsp;&nbsp;<input type=text name="reg_name" class="form" style="width:130;height:18px;" value="관리자"></TD>
										</TR>
										...
										<TR>
											...
											<TD font class=board>&nbsp;&nbsp;<input type=text name="title" class="form" style="width:370;height:18px;" size="61"></TD>
										</TR>
										<TR><TD colspan=2 background="images/board_linebg.gif"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
										<TR>
											<TD width=129 height=210 bgcolor="#369BD0" align=center><font color="#ffffff">내&nbsp;&nbsp;&nbsp;&nbsp;용</font></TD>
											<TD font class=board>&nbsp;&nbsp;<textarea name="content" class="form" style="width:370;height:200px;" rows="13" cols="65"></textarea></TD>
										</TR>
										<TR><TD colspan=2 background="images/board_linebg.gif"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
										<TR>
										...
										<TR><TD colspan=2 background="images/board_linebg.gif"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
										<!-- 아래 줄 빼먹지 마세요!!! -->
										<TR><TD colspan=9 bgcolor="#369BD0" height=25 font class=boardtext align=right><a href="board_list.jsp">[목록보기]</a> <a href="javascript:send();">[등록]</a> <a href="javascript:history.back()">[취소]</a>&nbsp;&nbsp;
									</TD></TR>
									</TABLE>							
								</TD>
							</TR>
