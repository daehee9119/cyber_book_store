								...
								<TD>
									<TABLE border="0" cellpadding="0" cellspacing="0" width="529">
										...
										<TR>
											...
											<TD font class=board>&nbsp;&nbsp;<input type=text name="title" class="form" style="width:370;height:18px;" value='<%=b_data.getTitle(false)%>' size="52"></TD>
										</TR>
										<TR><TD colspan=2 background="images/board_linebg.gif"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
										<TR>
                                                <TD width=129 height=210 bgcolor="#369BD0" align=center><font color="#ffffff">내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</font></TD>
											<TD font class=board>&nbsp;&nbsp;<textarea name="content" class="form" style="width:370;height:200px;" rows="13" cols="53"><%=b_data.getContent(false)%></textarea></TD>
										</TR>
										<TR><TD colspan=2 background="images/board_linebg.gif"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
										<TR>
