				...
				<TR>
					<TD width="634" valign=top>
						<TABLE border="0" cellpadding="0" cellspacing="0" width="635">
							<TR><TD width="635"><img src="images/blank.gif" width="1" height="15" alt="" border="0"></TD></TR>
							<!--<TR>
								<TD background="../images/notice_title.gif" width="529" height="56" align=right valign=bottom></TD>
							</TR>
							-->
							<TR>
                                    <TD background="images/page_title_bg.gif" width="635" height=44>
									<font size=3 color="#FFFFFF"><b>&nbsp;자료실 &amp;&nbsp;정오표&nbsp;관리</b></font>
								</TD>
							</TR>

							<TR><TD width="635"><img src="images/blank.gif" width="1" height="25" alt="" border="0"></TD></TR>
							<tr><td width="635">총 게시물수 :  <%=b_sel.getTotal()%> 개 Page : <%=b_sel.getCurrent_page()%> / <%=b_sel.getTotal_page()%> </td></tr>
							<TR>
								<TD width="635">
							...
							<input type='hidden' name='cmd' value='multi_del'> 		
									<TABLE border="0" cellpadding="0" cellspacing="0" width="603">
										<TR><TD colspan=8 bgcolor="#8E8E8E" width="555"><img src="images/blank.gif" width="1" height="2" alt="" border="0"></TD></TR>
										<TR align=center>
											<TD width=30 height=30>
											<input type="checkbox" name="no_all"  value="1" 
								<%  if(cnt < 1) { out.println(">"); }
									else { out.println("onClick='javascript:selectall(1);'>"); } %>>
								</TD>
											<TD width=30 font class=board>No.</TD>
											<TD width="66" font class=board>작성자</TD>
											<TD width="234" font class=board>제&nbsp;&nbsp;&nbsp;&nbsp;목</TD>
											<TD width="43" font class=board>파일</TD>
											<TD width="67" font class=board>등록일자</TD>
											<TD width=50 font class=board>조회수</TD>
											<TD width="35" font class=board>상태</TD>
										</TR>
										<TR><TD colspan=8 bgcolor="#8E8E8E" width="555"><img src="images/blank.gif" width="1" height="2" alt="" border="0"></TD></TR>
								<%  
								...
								%>
										<TR onMouseOver="this.style.backgroundColor='#EFEFEF'" onMouseOut="this.style.backgroundColor='' " align=center height=25>
											<TD width="30"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><input type="checkbox" name="no"  value="<%=be.getNum()%>"></TD>
											<TD width="30"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><%=(number--)%></TD>
											<TD width="66"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><%=be.getReg_name(han_yn)%></TD>
											
										<%	if(be.getDoc_step() == 0){ //부모글일 경우 	%>	
											   <TD align=left width="234"><img src="images/blank.gif" width="1" height="3" alt="" border="0">
										...
										%>	
											    <TD align=left width="43"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br>
										...
										<%  if(be.getFile_name1(han_yn).trim().length() > 0 ) {  %>
										       <TD width="67"><img src="images/icon/<%=Utility.file_ImgSel(be.getFile_name1(han_yn).trim())%>"   alt="" border="0"></TD>
										<%	}else { %>
											   <TD width="50">&nbsp;</TD>
										<%	}  %>
											<TD width="35"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><%=Utility.date_format1(be.getReg_date(), ".")%></TD>
											<TD width="16"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><%=be.getHit_cnt()%></TD>
										<%	if("Y".equals(be.getState())) {   %>	
											<TD width="16"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br>정상</TD>
										<%	} else {   %>
											<TD width="16"><img src="images/blank.gif" width="1" height="3" alt="" border="0"><br><a href="board_process.jsp?cmd=recovery&num=<%=be.getNum()%>&state=N">복원</a></TD>
										<%	}  %>	
										</TR>
										<TR><TD colspan=10 bgcolor="#D4D0C8" width="587"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
								<%	} 
									if(cnt < 1 ) {	 %>
										<TR onMouseOver="this.style.backgroundColor='#EFEFEF'" onMouseOut="this.style.backgroundColor='' " align=center height=25>
											<TD colspan=8 align="center" width="555"> 해당된 데이타가 없습니다!</TD>
										</TR>
										<TR><TD colspan=8 bgcolor="#D4D0C8" width="555"><img src="images/blank.gif" width="1" height="1" alt="" border="0"></TD></TR>
								<%	}   %>
							</form>	
								...
								%>
										<TR>
											<TD colspan=8 bgcolor="#369BD0" height=25 align=center width="555">
								...
								%>		
										<TR>
											<TD colspan=8 bgcolor="#035F8E" height=30 width="555">
										...
										<TR><TD colspan=8 width="555"><img src="images/blank.gif" width="1" height="10" alt="" border="0"></TD></TR>									
									</TABLE>							
								</TD>
							</TR>
						</TABLE>
					</TD>
					<TD width="24"><img src="images/blank.gif" width="20" height="1" alt="" border="0"></TD>
				</TR>
			</TABLE>
		</TD>
		<!-- body 끝 -->
