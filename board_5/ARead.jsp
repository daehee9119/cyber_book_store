...
<table align=center width=600 border=0 cellspacing=3 cellpadding=0>
 <tr>
                    <td bgcolor=9CA2EE height=25 align=center class=m>FAQ 내 용 보 기</td>
 </tr>
 <tr>
  <td colspan=2>
 ...
 <tr>
  <td align=center colspan=2> 
	...
	<a href="../board_5/AUpdate.jsp?page=<%=nowPage%>&num=<%=num%>">수 정</a> |
	<a href="../board_5/ADelete.jsp?page=<%=nowPage%>&num=<%=num%>">삭 제</a> ]<br>
  </td>
 </tr>
</table>
<%
