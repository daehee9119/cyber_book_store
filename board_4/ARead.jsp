...
<table align=center width="603" border=0 cellspacing=3 cellpadding=0>
 <tr>
  <td bgcolor=9CA2EE height=25 align=center class=m width="595">글읽기</td>
 </tr>
 <tr>
  <td colspan=2 width="597">
   <table border=0 cellpadding=3 cellspacing=0 width=100%> 
    <tr> 
	 ...
	 <td align=center bgcolor=#dddddd width="19%"> 등록날짜 </td>
    ...
    <tr> 
     <td align=center bgcolor=#dddddd width="59"> 제 목</td>
 ...
 <tr>
  <td align=center colspan=2 width="597"> 
	...
	<a href="../board_4/AUpdate.jsp?page=<%=nowPage%>&num=<%=num%>">수 정</a> |
	<a href="../board_4/AReply.jsp?page=<%=nowPage%>&num=<%=num%>">답 변</a> |
	<a href="../board_4/ADelete.jsp?page=<%=nowPage%>&num=<%=num%>">삭 제</a> ]<br>
  </td>
 </tr>
</table>
<%
