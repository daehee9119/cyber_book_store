...
<body oncontextmenu='return false' bgcolor="#ffFFFF" topmargin="0">
	...
	<%Vector vResult= proMgr.getProductList10();%>
...
<%//////////////////////////////////////////////////////////////////////////////////////%>
        ...
        <td valign="top" width="590" align="left" bgcolor="white">
            <table valign="top" width="590" align="center" bgcolor="white" cellspacing="0" style="border-collapse:collapse;">
                <tr bgcolor="#CCFFFF">
                    <td align="center" width="586" colspan=2 height="44" bgcolor="#FF66FF" style="border-width:1; border-color:black; border-style:none;"> 
<b><font size="5" color="#FFFF66"><span style="border-width:1; border-color:black; border-style:none;">출간예정 도서목록</span></font></b><font size="5">  </font></td>
				</tr> 
<% 
...
<%//////////////////////////////////////////////////////////////////////////////////////%>
	...
	<form name="detail" method="post" action="ProductDetail10.jsp">
