/*
	...
	<A HREF="javascript:mail()">☞추천 메일을 보내주세요.</A>
*/
	function mail(){
		mail_str = "mailto:?subject=추천 사이트: "+location.href;
		mail_str += "&body=여기를 한번 방문해 보세요.";
		mail_str += "혼자 보기 아까워서 메일 보냅니다."+location.href; 
