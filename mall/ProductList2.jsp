...
<body oncontextmenu='return false' bgcolor="#ffFFFF" topmargin="0">
	...
	<%Vector vResult= proMgr.getProductList2();%>
...
<%//////////////////////////////////////////////////////////////////////////////////////%>
        ...
        <td valign="top" width="590" align="left" bgcolor="white">
            <table valign="top" width="590" align="center" bgcolor="white" cellspacing="0" style="border-collapse:collapse;">
                <tr bgcolor="#CCFFFF">
                    <td align="center" width="586" colspan=2 height="44" bgcolor="#99FF00" style="border-width:1; border-color:black; border-style:none;"> 
<font size="5" color="#FF6600">데이터베이스 도서목록</font>					<font size="5">  </font></td>
				</tr> 
<% 
