...
<jsp:getProperty name="regBean" property="mem_name" />
		회원님이 작성하신 내용입니다. 확인해 주세요</font></b></td>
		</tr> 
		<tr> 
		<td>아이디</td>
		...
		<tr> 
		<td colspan="2" align="center" bgcolor="white" style="border-width:1; border-color:black; border-style:none;"><input type="submit" value="확인완료"> 
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
